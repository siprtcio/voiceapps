...
<Condition></Condition>
<Response><Gather action="https://demo.siprtc.io/SiprtcApplications/VoxvellyDemoDtmfReceived" method="POST" finishOnKey="#" numDigits="1"><Say>Welcome to the voxvalley technologies. Press 1 for sales, Press 2 for support.</Say></Gather><Say>We didn&#39;t receive any input. Goodbye!</Say></Response>
<ChildrenNodes>
